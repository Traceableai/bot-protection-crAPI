...
public class TraceableCaptchaController {
    ...
    @Autowired
    private TraceableCaptchaValidateTokenService validateTokenService;
    ...
    public ResponseEntity<?> validateToken(@RequestBody Map<String, String> requestBody, HttpServletRequest request) {
